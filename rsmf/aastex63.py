"""
Support for the aastex documentclass of AAS journals.
"""
...
class aastex63Formatter:
    def __init__(self, columns="twocolumn", paper="letterpaper", fontsize=10):
        """Sets up the plot with the fitting arguments so that the font sizes of the plot
        and the font sizes of the document are well aligned.

        Args:
            columns (str, optional):  the columns you used to set up your AAS journals article,
                either "onecolumn" or "twocolumn". Defaults to "twocolumn".
            paper (str, optional): the paper size you used to set up your AAS journals article,
                either "a4paper" or "letterpaper". Defaults to "a4paper".
            fontsize (int, optional): the fontsize you used to set up your AAS journals article,
...
def parse(preamble):
    ...
    Returns:
        Union[NoneType,aastec63]: AASarticle object with the relevant properties if the preamble
            is for a AASarticle document. None otherwise.
    """
    if not "{aastex63}" in preamble:
        return None
    ...
    return aastex63Formatter(**kwargs)
